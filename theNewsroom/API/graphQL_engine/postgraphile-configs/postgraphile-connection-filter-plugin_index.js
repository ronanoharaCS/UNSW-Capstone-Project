/**
 * index.js that contains configurations for this plugin that attaches
 * itself to our GraphQL engine 'Postgraphile'
 * 
 * With comments, I've noted where the configuration data is set
 */
...
module.exports = function PostGraphileConnectionFilterPlugin(
  ...
  const defaultOptions = {
    ...
    // Allow filtering on relations - changed from false
